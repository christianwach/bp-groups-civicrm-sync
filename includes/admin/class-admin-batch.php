 ...
 * @since 0.5.0
 */
class BP_Groups_CiviCRM_Sync_Admin_Batch {
	 ...
	 * @since 0.5.0
	 * @access public
	 * @var BP_Groups_CiviCRM_Sync_Admin_Stepper
	 */
	public $stepper;
	...
	public function __construct( $identifier ) {
		...
		$this->stepper = new BP_Groups_CiviCRM_Sync_Admin_Stepper( $identifier );
	...
	public function delete() {
		...
		if ( ! isset( $this->stepper ) ) {
			$this->stepper = new BP_Groups_CiviCRM_Sync_Admin_Stepper( $this->identifier );
		}
		$this->stepper->delete();
		unset( $this->stepper );

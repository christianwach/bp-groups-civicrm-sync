 ...
 * @since 0.5.0
 */
abstract class BP_Groups_CiviCRM_Sync_Page_Settings_Base {
	...
	protected function admin_help_get() {
		...
		if ( ! file_exists( $template ) ) {
			$template = BP_GROUPS_CIVICRM_SYNC_PATH . $this->path_template . $this->path_help . 'page-settings-help.php';
		}
	...
	public function page_render() {
		...
		if ( ! file_exists( $template ) ) {
			$template = BP_GROUPS_CIVICRM_SYNC_PATH . $this->path_template . $this->path_page . $template_name;
		}
	...
	public function meta_box_submit_render( $unused, $metabox ) {
		...
		if ( ! file_exists( $template ) ) {
			$template = BP_GROUPS_CIVICRM_SYNC_PATH . $this->path_template . $this->path_metabox . 'metabox-settings-submit.php';
		}

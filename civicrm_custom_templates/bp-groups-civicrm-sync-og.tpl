...
<tr>
  <td colspan="2"><p style="color: red;"><strong>WARNING:</strong> You may wish to make sure your CiviCRM contacts exist as WordPress users before creating this group. CiviCRM contacts that do not have a corresponding WordPress user will have one created for them. You will need to review roles for the new WordPress users when this process is complete.</p></td>
</tr>
<tr>
